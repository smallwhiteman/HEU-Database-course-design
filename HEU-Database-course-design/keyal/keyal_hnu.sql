...
-- ----------------------------
INSERT INTO `dispatcher` VALUES ('111111', '路人甲', '13811111111');
...
-- Records of oorder
-- ----------------------------
INSERT INTO `oorder` VALUES (1, '鸡公煲', 12, '人工订餐', '13800000000', '潘俊衡', '3区11', 0, '2025-12-16 14:35:17');
INSERT INTO `oorder` VALUES (2, '师大烤盘饭', 10, '人工订餐', '13811111111', '傅程凯', '3区11', 2, '2025-12-16 14:35:26');
INSERT INTO `oorder` VALUES (3, '隆江猪脚饭', 20, '人工订餐', '13511111111', '思思', '3区9', 0, '2025-12-16 14:35:35');

-- ----------------------------
-- Records of comments
-- ----------------------------
INSERT INTO `comments` (`shop_name`, `username`, `telephone`, `score`, `content`) VALUES
('鸡公煲', '潘俊衡', '13800000000', 5, '味道超级好，鸡肉很嫩，配菜丰富！'),
('鸡公煲', '傅程凯', '13811111111', 3, '味道不错，就是有点咸，下次少放盐'),
('隆江猪脚饭', '潘俊衡', '13800000000', 5, '猪脚炖得很烂，非常入味！'),
('天马自选饭', '潘俊衡', '13800000000', 4, '性价比高，选择多样');
...
-- Records of server
-- ----------------------------
INSERT INTO `server` VALUES ('100000', '服务员0号', '师大烤盘饭');
INSERT INTO `server` VALUES ('100001', '服务员1号', '隆江猪脚饭');
INSERT INTO `server` VALUES ('100002', '服务员2号', '鸡公煲');
...
-- Records of user_msg
-- ----------------------------
INSERT INTO `user_msg` VALUES (2, '潘俊衡', '男', 20, '000000@qq.com', '13800000000', '潘俊衡');
INSERT INTO `user_msg` VALUES (3, '傅程凯', '男', 20, '111111@qq.com', '13811111111', '傅程凯');
INSERT INTO `user_msg` VALUES (4, '傅程凯', '男', 20, 'admin123@qq.com', '13888888888', '傅程凯');

-- ----------------------------
-- Records of feedback
-- ----------------------------
INSERT INTO `feedback` (`user_id`, `username`, `telephone`, `feedback_content`, `feedback_type`) VALUES
(2, '潘俊衡', '13800000000', '配送速度有点慢，希望能改进', '投诉'),
(2, '潘俊衡', '13800000000', '建议增加更多优惠活动', '建议'),
(3, '傅程凯', '13811111111', '商家服务态度很好，点赞！', '其他'),
(2, '潘俊衡', '13800000000', '订单状态更新不及时', '投诉'),
(3, '傅程凯', '13811111111', '希望增加更多的支付方式', '建议');
